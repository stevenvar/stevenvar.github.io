...
(* to do list : *)
(* deterministic run : done in version 10 *)
(* replace length by cost function : done in version 11 *)
(* abstract cost function : done in version 12 *)
(* corollaries about "step" instead of "step_opt" : done in version 13 *)
(* normal_run is (final o last) : done in version 14 *)
(* max_cost with Nat.max : done in version 15 *)

(** printing ==? %\ensuremath{\downarrow=}% *)
(** printing val %\textup{\coqdockw{val}}% *)
(** printing ret %\textup{\coqdockw{ret}}% *)
